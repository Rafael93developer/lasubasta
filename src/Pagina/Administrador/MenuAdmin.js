...
class MenuAdmin extends React.Component {
    render() {
        return (
          ...
          <img class="navbar-brand py-0" src={A} width="50" alt="" />
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-auto py-0">
              ...
              <li class="nav-item px-4">
                ...
                <NavLink to={"/InicioA"} className="nav-link py-0" style={{ textDecoration: 'none' }} activeStyle={{ fontWeight: "bold", color: "#424242" }}>
                  Inicio
                </NavLink>
              </li>
              <li class="nav-item px-4">
              <NavLink to={"/Subasta"} className="nav-link py-0" style={{ textDecoration: 'none' }} activeStyle={{ fontWeight: "bold", color: "#424242" }}>
                  Subasta
                </NavLink>
              </li>
              <li class="nav-item px-4">
              <NavLink to={"/Venta"} className="nav-link py-0" style={{ textDecoration: 'none' }} activeStyle={{ fontWeight: "bold", color: "#424242" }}>
                  Venta
                </NavLink>
              </li>
